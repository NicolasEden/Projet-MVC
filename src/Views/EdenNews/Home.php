                    ...
                    <div class="flex-center">
                        <div class="content col-10">
                            ...
                            <ul class="bigpost-infos col-6">
                                <li><i class="fas fa-comments"></i> <span><?= $hottest->getComments() ?></span> Commentaires</li>
                                <li><i class="fas fa-share-alt"></i> <span><?= $hottest->getShares() ?></span> Shares</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="medium-right-articles">
                        <div class="col-sm-md-12">
                            <div class="mediumpost post" style="background-image: url('/<?= $mostViews[0]->getImage()?>');">
                                <div class="postcomment" style="background-color: #f72300;">
                                    <p>LA PLUS VUE</p>
                                </div>
                                <div class="flex-center">
                                    <div class="content col-10">
                                        ...
                                        <ul class="bigpost-infos col-8">
                                            <li><i class="fas fa-comments"></i> <span><?= $mostViews[0]->getComments() ?></span> Commentaires</li>
                                            <li><i class="fas fa-share-alt"></i> <span><?= $mostViews[0]->getShares() ?></span> Shares</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-md-12">
                            <div class="mediumpost post" style="background-image: url('/<?= $mostViews[1]->getImage()?>');">
                                <div class="postcomment" style="background-color: #f72300;">
                                    <p>LA PLUS VUE</p>
                                </div>
                                <div class="flex-center">
                                    <div class="content col-10">
                                        ...
                                        <ul class="bigpost-infos col-8">
                                            <li><i class="fas fa-comments"></i> <span><?= $mostViews[1]->getComments() ?></span> Commentaires</li>
                                            <li><i class="fas fa-share-alt"></i> <span><?= $mostViews[1]->getShares() ?></span> Shares</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
